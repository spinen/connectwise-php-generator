...
class Configuration
{
     ...
     *
     * @var \Spinen\ConnectWise\Library\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'http://api-na.myconnectwise.net/v4_6_release/apis/3.0';
     ...
     * @var string
     */
    protected $userAgent = "PHP-Swagger/3.0.0";
    ...
    {
        $report  = "PHP SDK (Spinen\ConnectWise\Library) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
